...
def register_platform_tools(registry) -> None:
    definitions = [
        ...
        ToolDefinition(
            ...
            description="Read pull request review comments.",
            handler=github_get_pr_comments,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            ...
            description="Read combined commit CI status.",
            handler=github_get_commit_status,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
                "properties": {"repository": {"type": "string"}, "sha": {"type": "string"}},
        ...
        ToolDefinition(
            ...
            handler=github_list_workflow_jobs,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            ...
            handler=github_create_issue_comment,
            allowed_plans=WRITE_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            ...
            description="Merge a pull request after CI/review checks pass.",
            handler=github_merge_pull_request,
        ...
        ToolDefinition(
            ...
            description="Re-run failed GitHub Actions jobs for a workflow run.",
            handler=github_rerun_failed_jobs,
            allowed_plans=WRITE_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            ...
            handler=vercel_list_deployments,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            ...
            handler=vercel_create_deployment,
            allowed_plans=WRITE_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            ...
            handler=vercel_cancel_deployment,
            allowed_plans=WRITE_PLANS,
            parameters={
                "type": "object",
                "properties": {"deployment": {"type": "string"}},
        ...
        ToolDefinition(
            ...
            description="List Railway services.",
            handler=railway_list_services,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
        ...
        ToolDefinition(
            ...
            description="List Railway deployments.",
            handler=railway_get_deployments,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
        ...
        ToolDefinition(
            ...
            description="Get a Railway deployment.",
            handler=railway_get_deployment,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
        ...
        ToolDefinition(
            ...
            description="Redeploy a Railway deployment.",
            handler=railway_redeploy,
            allowed_plans=WRITE_PLANS,
            parameters={
                "type": "object",
                "properties": {"deployment_id": {"type": "string"}},
        ...
        ToolDefinition(
            ...
            handler=railway_restart_service,
            allowed_plans=WRITE_PLANS,
            parameters={
                "type": "object",
                "properties": {"service_id": {"type": "string"}},
        ...
        ToolDefinition(
            ...
            description="Get Supabase project details.",
            handler=supabase_get_project,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
                "properties": {"project_id": {"type": "string"}},
        ...
        ToolDefinition(
            ...
            description="List Supabase branches.",
            handler=supabase_list_branches,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
                "properties": {"project_id": {"type": "string"}},
        ...
        ToolDefinition(
            ...
            handler=supabase_list_edge_functions,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
                "properties": {"project_id": {"type": "string"}},
        ...
        ToolDefinition(
            ...
            description="Read Supabase security or performance advisors.",
            handler=supabase_get_advisors,
            allowed_plans=READ_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            ...
            description="List files in the isolated terminal sandbox.",
            handler=terminal_list_directory,
        ...
        ToolDefinition(
            ...
            description="Read a file from the isolated terminal sandbox.",
            handler=terminal_read_file,
            allowed_plans=TERMINAL_PLANS,
            parameters={
                "type": "object",
                "properties": {"path": {"type": "string"}, "cwd": {"type": "string"}},
        ...
        ToolDefinition(
            ...
            description="Write a file inside the isolated terminal sandbox.",
            handler=terminal_write_file,
            allowed_plans=TERMINAL_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            name="terminal_git_branch",
            description="List git branches.",
            handler=terminal_git_branch,
            allowed_plans=TERMINAL_PLANS,
            parameters={
                "type": "object",
                "properties": {"cwd": {"type": "string"}},
        ...
        ToolDefinition(
            name="terminal_git_checkout",
            description="Checkout a branch in the sandbox workspace.",
            handler=terminal_git_checkout,
            allowed_plans=TERMINAL_PLANS,
            parameters={
                "type": "object",
        ...
        ToolDefinition(
            ...
            description="Commit staged workspace changes in the sandbox.",
            handler=terminal_git_commit,
            allowed_plans=TERMINAL_PLANS,
            parameters={
                "type": "object",
            ...
            requires_confirmation=True,
            risk_level=ToolRisk.WRITE,
            # 65 not 60: the sandbox may use its full 60s cap and the client
            # adds 5s for the round trip. At exactly 60 the executor abandons
            # work that actually succeeded, and the user is told it failed.
            timeout_seconds=65,
            max_calls_per_request=2,
        ),
        ToolDefinition(
            name="terminal_run_tests",
            description="Run tests in the isolated sandbox.",
            handler=terminal_run_tests,
            allowed_plans=TERMINAL_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            name="terminal_run_lint",
            description="Run lint checks in the isolated sandbox.",
            handler=terminal_run_lint,
            allowed_plans=TERMINAL_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            name="terminal_run_build",
            description="Run a build in the isolated sandbox.",
            handler=terminal_run_build,
            allowed_plans=TERMINAL_PLANS,
            parameters={
                "type": "object",
                "properties": {
        ...
        ToolDefinition(
            ...
            description="Install a package in the isolated sandbox.",
            handler=terminal_install_package,
            allowed_plans=TERMINAL_PLANS,
            parameters={
                "type": "object",
                "properties": {
                    "manager": {"type": "string", "enum": ["npm", "pnpm", "yarn", "pip"]},
                    "package": {"type": "string"},
                    "cwd": {"type": "string"},
                },
