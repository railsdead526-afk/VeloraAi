...
def register_platform_tools(registry) -> None:
    definitions = [
        ...
        ToolDefinition(name="github_list_contents", description="List files and directories at a repository path (use path empty or / for top-level files).", handler=github_list_contents, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"path":{"type":"string"},"ref":{"type":"string"}},"required":["repository"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=5),
        ...
        ToolDefinition(name="github_get_pr_comments", description="Read pull request comments.", handler=github_get_pr_comments, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"pr_number":{"type":"integer","minimum":1}},"required":["repository","pr_number"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=5),
        ToolDefinition(name="github_get_commit_status", description="Read commit status checks.", handler=github_get_commit_status, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"sha":{"type":"string"}},"required":["repository","sha"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=5),
        ToolDefinition(name="github_list_workflow_jobs", description="List GitHub Actions workflow jobs for a run.", handler=github_list_workflow_jobs, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"run_id":{"type":"integer","minimum":1}},"required":["repository","run_id"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=5),
        ToolDefinition(name="github_create_branch", description="Create a new branch from a source branch.", handler=github_create_branch, allowed_plans=WRITE_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"name":{"type":"string"},"source":{"type":"string"}},"required":["repository","name"],"additionalProperties":False}, requires_confirmation=True, timeout_seconds=15, max_calls_per_request=2, risk_level="write"),
        ToolDefinition(name="github_write_file", description="Create or update a file in a repository.", handler=github_write_file, allowed_plans=WRITE_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"path":{"type":"string"},"content":{"type":"string"},"message":{"type":"string"},"branch":{"type":"string"}},"required":["repository","path","content"],"additionalProperties":False}, requires_confirmation=True, timeout_seconds=20, max_calls_per_request=3, risk_level="write"),
        ...
        ToolDefinition(name="github_create_issue_comment", description="Add a comment to an issue.", handler=github_create_issue_comment, allowed_plans=WRITE_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"issue_number":{"type":"integer","minimum":1},"body":{"type":"string"}},"required":["repository","issue_number","body"],"additionalProperties":False}, requires_confirmation=True, timeout_seconds=15, max_calls_per_request=2, risk_level="write"),
        ToolDefinition(name="github_create_pull_request", description="Open a pull request.", handler=github_create_pull_request, allowed_plans=WRITE_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"title":{"type":"string"},"head":{"type":"string"},"base":{"type":"string"},"body":{"type":"string"}},"required":["repository","title","head"],"additionalProperties":False}, requires_confirmation=True, timeout_seconds=20, max_calls_per_request=2, risk_level="write"),
        ToolDefinition(name="github_merge_pull_request", description="Merge a pull request.", handler=github_merge_pull_request, allowed_plans=WRITE_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"pr_number":{"type":"integer","minimum":1},"merge_method":{"type":"string","enum":["merge","squash","rebase"]},"expected_head_sha":{"type":"string"}},"required":["repository","pr_number"],"additionalProperties":False}, requires_confirmation=True, timeout_seconds=20, max_calls_per_request=2, risk_level="destructive"),
        ToolDefinition(name="github_rerun_failed_jobs", description="Rerun failed jobs in a workflow run.", handler=github_rerun_failed_jobs, allowed_plans=WRITE_PLANS, parameters={"type":"object","properties":{"repository":{"type":"string"},"run_id":{"type":"integer","minimum":1}},"required":["repository","run_id"],"additionalProperties":False}, requires_confirmation=True, timeout_seconds=15, max_calls_per_request=1, risk_level="write"),
        ...
        ToolDefinition(name="railway_redeploy", description="Redeploy a Railway service.", handler=railway_redeploy, allowed_plans=WRITE_PLANS, parameters={"type":"object","properties":{"service_id":{"type":"string"},"environment_id":{"type":"string"}},"required":["service_id","environment_id"],"additionalProperties":False}, requires_confirmation=True, timeout_seconds=30, max_calls_per_request=2, risk_level="write"),
        ...
        ToolDefinition(name="vercel_list_deployments", description="List Vercel deployments.", handler=vercel_list_deployments, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"project_id":{"type":"string"},"limit":{"type":"integer","minimum":1,"maximum":100}},"required":["project_id"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=5),
        ToolDefinition(name="vercel_get_deployment", description="Get Vercel deployment details.", handler=vercel_get_deployment, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"deployment_id":{"type":"string"}},"required":["deployment_id"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=5),
        ToolDefinition(name="vercel_get_project", description="Get Vercel project details.", handler=vercel_get_project, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"project_id":{"type":"string"}},"required":["project_id"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=3),
        ...
        ToolDefinition(name="vercel_create_deployment", description="Create a Vercel deployment.", handler=vercel_create_deployment, allowed_plans=WRITE_PLANS, parameters={"type":"object","properties":{"project_id":{"type":"string"},"target":{"type":"string"}},"required":["project_id"],"additionalProperties":False}, requires_confirmation=True, timeout_seconds=30, max_calls_per_request=2, risk_level="write"),
        ToolDefinition(name="vercel_cancel_deployment", description="Cancel a Vercel deployment.", handler=vercel_cancel_deployment, allowed_plans=WRITE_PLANS, parameters={"type":"object","properties":{"deployment_id":{"type":"string"}},"required":["deployment_id"],"additionalProperties":False}, requires_confirmation=True, timeout_seconds=15, max_calls_per_request=2, risk_level="destructive"),
        ...
        ToolDefinition(name="supabase_list_branches", description="List Supabase database branches.", handler=supabase_list_branches, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"project_id":{"type":"string"}},"required":["project_id"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=3),
        ToolDefinition(name="supabase_list_edge_functions", description="List Supabase edge functions.", handler=supabase_list_edge_functions, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"project_id":{"type":"string"}},"required":["project_id"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=3),
        ToolDefinition(name="supabase_get_project", description="Get Supabase project details.", handler=supabase_get_project, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"project_id":{"type":"string"}},"required":["project_id"],"additionalProperties":False}, timeout_seconds=15, max_calls_per_request=3),
        ToolDefinition(name="supabase_get_advisors", description="Get Supabase security/performance advisors.", handler=supabase_get_advisors, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"project_id":{"type":"string"},"type":{"type":"string","enum":["security","performance"]}},"required":["project_id"],"additionalProperties":False}, timeout_seconds=20, max_calls_per_request=2),
        ToolDefinition(name="supabase_execute_sql", description="Execute a read-only SQL query against a Supabase project.", handler=supabase_execute_sql, allowed_plans=READ_PLANS, parameters={"type":"object","properties":{"project_id":{"type":"string"},"query":{"type":"string"}},"required":["project_id","query"],"additionalProperties":False}, timeout_seconds=30, max_calls_per_request=3),
        ToolDefinition(name="terminal_list_directory", description="List files in a workspace directory.", handler=terminal_list_directory, allowed_plans=TERMINAL_PLANS, parameters={"type":"object","properties":{"path":{"type":"string"}},"additionalProperties":False}, timeout_seconds=30, max_calls_per_request=5),
        ToolDefinition(name="terminal_read_file", description="Read a file from the workspace.", handler=terminal_read_file, allowed_plans=TERMINAL_PLANS, parameters={"type":"object","properties":{"path":{"type":"string"}},"required":["path"],"additionalProperties":False}, timeout_seconds=30, max_calls_per_request=5),
        ToolDefinition(name="terminal_git_status", description="Read git status.", handler=terminal_git_status, allowed_plans=TERMINAL_PLANS, parameters={"type":"object","properties":{"cwd":{"type":"string"}},"additionalProperties":False}, timeout_seconds=30, max_calls_per_request=3),
