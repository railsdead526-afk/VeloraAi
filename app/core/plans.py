...
PLANS: dict[str, PlanPolicy] = {
    "free": PlanPolicy(
        name="free", monthly_token_limit=100_000, monthly_request_limit=100, daily_request_limit=20
    ),
    "pro": PlanPolicy(
        name="pro",
    ...
    "admin": PlanPolicy(
        name="admin", monthly_token_limit=None, monthly_request_limit=None, daily_request_limit=None
    ),
}
